...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="mods:mods">
        ...
        <!-- This script tests for a top level element. If that element exists it records the element and selected attributes. A single row will be created for each PID, with multiple values separated by an | -->
